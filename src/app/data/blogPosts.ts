...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    contentHtml: `
      <section id="introduction" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">1. The E-Commerce Fragrance Landscape in Dubai</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
        ...
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-6">
      ...
      <section id="why-authenticity" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">2. Why Authenticity Matters in Dubai's Luxury Market</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
        ...
        <div class="my-6 p-6 bg-[#F5F5F5] border-l border-black/25">
          <h4 class="font-medium text-black text-sm uppercase tracking-wider mb-2">Key Authenticity Fact</h4>
          <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed">
      ...
      <section id="counterfeit-checks" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">3. How to Spot Counterfeit Perfumes Online: 5 Crucial Checks</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
          Before clicking "Order Now" on any online store in the UAE, perform these 5 essential authenticity checks:
        </p>
        <ol class="list-decimal pl-6 space-y-3 text-base text-[rgba(0,0,0,0.8)] mb-6">
      ...
      <section id="gharib-sourcing" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">4. Gharib’s Direct Sourcing & Batch Code Verification</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
      ...
      <section id="top-perfumes-online" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">5. Top 5 Authentic Perfumes to Buy Online in Dubai</h2>
        <div class="overflow-x-auto mb-6">
          <table class="w-full text-left border-collapse border border-black/12 text-xs">
            <thead>
              <tr class="bg-black text-white">
                <th class="p-3 border border-black/15">Fragrance Name</th>
                <th class="p-3 border border-black/15">Brand</th>
                <th class="p-3 border border-black/15">Key Notes</th>
                <th class="p-3 border border-black/15">Longevity</th>
                <th class="p-3 border border-black/15">Ideal Season</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-black/10 bg-white">
              <tr>
                <td class="p-3 font-medium text-black">Hawas for Him</td>
              ...
              <tr>
                <td class="p-3 font-medium text-black">Khamrah Extrait</td>
              ...
              <tr>
                <td class="p-3 font-medium text-black">Club de Nuit Intense</td>
              ...
              <tr>
                <td class="p-3 font-medium text-black">Bade'e Al Oud Honor</td>
                <td class="p-3">Lattafa</td>
              ...
              <tr>
                <td class="p-3 font-medium text-black">Wisal Dhahab</td>
      ...
      <section id="delivery-payment" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">6. Same-Day UAE Express Delivery & Payment Rails</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
          When you buy perfume online in Dubai from Gharib, speed and security are standard. We offer:
        </p>
        <ul class="list-disc pl-6 space-y-2 text-base text-[rgba(0,0,0,0.8)] mb-6">
      ...
      <section id="faq" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">7. Frequently Asked Questions (FAQ)</h2>
        <div class="space-y-4 mb-6">
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h3 class="font-medium text-sm text-black mb-1">How can I make sure I buy 100% authentic perfume online in Dubai?</h3>
            <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed">Always buy from authorized UAE fragrance houses like Gharib that source directly from brand manufacturing plants and provide verifiable manufacturer batch codes stamped on the outer box and bottle base.</p>
          </div>
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h3 class="font-medium text-sm text-black mb-1">Does Gharib offer same-day perfume delivery in Dubai?</h3>
            <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed">Yes! Orders placed before 2:00 PM GST receive express same-day delivery within Dubai, Sharjah, and Ajman, and next-day delivery across Abu Dhabi, Al Ain, and RAK.</p>
          </div>
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h3 class="font-medium text-sm text-black mb-1">Can I verify the batch code of my perfume online?</h3>
            <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed">Every authentic perfume bottle sold at Gharib features a laser-etched batch code on the bottle base matching the box stamp, which can be validated on global databases like CheckFresh or directly through brand customer service.</p>
          </div>
        </div>
      </section>

      <section id="conclusion" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">8. Final Verdict: Safely Buying Perfumes Online in Dubai</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-6">
  ...
  },
  {
    ...
    contentHtml: `
      <section id="understanding-climate" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">1. Longevity in Dubai's Climate & High Humidity</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
      ...
      <section id="concentration-guide" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">2. Concentration Guide: EDP vs Extrait de Parfum</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
      ...
      <section id="heat-resistant-notes" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">3. Heavy Scent Notes That Withstand UAE Heat</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
          Emirati perfumers rely on robust natural resins and fixatives to lock down fragrance molecules:
        </p>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h4 class="font-medium text-black text-sm uppercase tracking-wide mb-1">Dehn El Oud (Agarwood)</h4>
            <p class="text-xs text-[rgba(0,0,0,0.8)]">Deep, smoky, and resinous. Fixes lighter florals and fruits to skin for 12+ hours.</p>
          </div>
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h4 class="font-medium text-black text-sm uppercase tracking-wide mb-1">Ambergris & Saline Musks</h4>
            <p class="text-xs text-[rgba(0,0,0,0.8)]">Creates an atomic trail (sillage) that cuts through humid air with radiant freshness.</p>
          </div>
        </div>
      </section>

      <section id="top-10-ranking" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">4. Top 10 Long-Lasting Perfumes (Ranked)</h2>
        <div class="overflow-x-auto mb-6">
          <table class="w-full text-left border-collapse border border-black/12 text-xs">
            <thead>
              <tr class="bg-black text-white">
                <th class="p-3 border border-black/15">Rank</th>
                <th class="p-3 border border-black/15">Perfume</th>
                <th class="p-3 border border-black/15">House</th>
                <th class="p-3 border border-black/15">Sillage & Longevity</th>
                <th class="p-3 border border-black/15">Key Accord</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-black/10 bg-white">
              <tr>
                <td class="p-3 font-medium text-black">#1</td>
                <td class="p-3 font-medium text-black">Hawas for Him</td>
                <td class="p-3">Rasasi</td>
              ...
              <tr>
                <td class="p-3 font-medium text-black">#2</td>
                <td class="p-3 font-medium text-black">Bade'e Al Oud Honor</td>
                <td class="p-3">Lattafa</td>
                <td class="p-3">14+ Hours</td>
              ...
              <tr>
                <td class="p-3 font-medium text-black">#3</td>
                <td class="p-3 font-medium text-black">Club de Nuit Intense</td>
                <td class="p-3">Armaf</td>
                <td class="p-3">12+ Hours</td>
              ...
              <tr>
                <td class="p-3 font-medium text-black">#4</td>
                <td class="p-3 font-medium text-black">Khamrah Extrait</td>
                <td class="p-3">Lattafa</td>
              ...
              <tr>
                <td class="p-3 font-medium text-black">#5</td>
                <td class="p-3 font-medium text-black">La Yuqawam Homme</td>
                <td class="p-3">Rasasi</td>
                <td class="p-3">14+ Hours</td>
      ...
      <section id="layering-secrets" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">5. 14-Hour Longevity Layering Protocol</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
          Follow this 3-step Emirati layering ritual used by Dubai locals to guarantee all-day performance:
        </p>
        <ol class="list-decimal pl-6 space-y-2 text-base text-[rgba(0,0,0,0.8)] mb-6">
      ...
      <section id="faq" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">6. Frequently Asked Questions (FAQ)</h2>
        <div class="space-y-4 mb-6">
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h3 class="font-medium text-sm text-black mb-1">Which fragrance concentration lasts longest in Dubai heat?</h3>
            <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed">Extrait de Parfum (20%-40% oil concentration) and concentrated Dehn El Oud oils perform best in Dubai's heat because high oil ratios evaporate slower under high temperatures.</p>
          </div>
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h3 class="font-medium text-sm text-black mb-1">What scent notes last longest in the Middle East?</h3>
            <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed">Heavy resinous base notes like Agarwood (Oud), Amber, Ambergris, Vetiver, Oakmoss, Patchouli, and Musk hold up best against humidity and high heat.</p>
          </div>
        </div>
      </section>

      <section id="summary" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">7. Final Thoughts on Beast-Mode Fragrances</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-6">
  ...
  },
  {
    ...
    contentHtml: `
      <section id="rise-of-emirati-brands" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">1. The Rise of Lattafa & Rasasi</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
      ...
      <section id="factory-direct-sourcing" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">2. Why Buy Direct from UAE Distributors</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
      ...
      <section id="batch-verification" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">3. Complete Authenticity & Batch Stamp Guide</h2>
        <div class="p-6 bg-[#F5F5F5] border-l border-black/25 mb-6">
          <h4 class="font-medium text-black text-sm uppercase tracking-wider mb-2">Lattafa Security Hologram & Batch Stamp</h4>
          <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed mb-3">
          ...
          <h4 class="font-medium text-black text-sm uppercase tracking-wider mb-2">Rasasi Embossed Crest</h4>
          <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed">
      ...
      <section id="lattafa-must-haves" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">4. Top 5 Iconic Lattafa Fragrances</h2>
        <ol class="list-decimal pl-6 space-y-3 text-base text-[rgba(0,0,0,0.8)] mb-6">
      ...
      <section id="rasasi-must-haves" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">5. Top 5 Iconic Rasasi Fragrances</h2>
        <ol class="list-decimal pl-6 space-y-3 text-base text-[rgba(0,0,0,0.8)] mb-6">
      ...
      <section id="faq" class="scroll-mt-28">
        ...
        <div class="space-y-4 mb-6">
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h3 class="font-medium text-sm text-black mb-1">Where are Lattafa and Rasasi perfumes manufactured?</h3>
            <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed">Both Lattafa and Rasasi are proudly Emirati brands manufactured in state-of-the-art production plants located in the United Arab Emirates (Dubai and Sharjah).</p>
          </div>
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h3 class="font-medium text-sm text-black mb-1">How can I verify authentic Lattafa and Rasasi perfume in Dubai?</h3>
            <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed">Check for the 3D metallic security hologram sticker on Lattafa boxes, laser-etched 6-digit batch codes on bottle bases, and buy directly from authorized UAE stockists like Gharib.</p>
          </div>
        </div>
      </section>

      <section id="conclusion" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">7. Order Authentic Lattafa & Rasasi at Gharib</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-6">
  ...
  },
  {
    ...
    contentHtml: `
      <section id="sacred-history" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">1. Sacred History of Oud in Emirati Heritage</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
      ...
      <section id="what-is-oud" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">2. What is Oud? Agarwood Resin Science</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
      ...
      <section id="regional-distinctions" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">3. Regional Oud Distinctions (Cambodian vs Assam)</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h4 class="font-medium text-black text-sm uppercase tracking-wide mb-1">Cambodian Oud (Oud Seufi)</h4>
            <p class="text-xs text-[rgba(0,0,0,0.8)]">Warm, honeyed, sweet dried fruit accords with soft balsamic warmth. Highly prized in Dubai boutique perfumery.</p>
          </div>
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h4 class="font-medium text-black text-sm uppercase tracking-wide mb-1">Indian Assam Oud</h4>
            <p class="text-xs text-[rgba(0,0,0,0.8)]">Deep, smoky, leather-bound, and bold. Perfect for cold evenings and grand occasions.</p>
          </div>
        </div>
      </section>

      <section id="layering-rituals" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">4. Royal Emirati Oud Layering Rituals</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-4">
      ...
      <section id="faq" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">5. Frequently Asked Questions (FAQ)</h2>
        <div class="space-y-4 mb-6">
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h3 class="font-medium text-sm text-black mb-1">What makes Dehn El Oud so valuable in Dubai?</h3>
            <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed">Dehn El Oud is extracted from resinous heartwood produced by infected Aquilaria trees. It takes decades to form natively, making pure agarwood oil worth more than gold per ounce.</p>
          </div>
          <div class="p-4 bg-[#F5F5F5] border border-black/12">
            <h3 class="font-medium text-sm text-black mb-1">What is the difference between Indian Assam Oud and Cambodian Oud?</h3>
            <p class="text-xs text-[rgba(0,0,0,0.8)] leading-relaxed">Indian Assam Oud is intense, dark, earthy, and animalic, whereas Cambodian Oud is sweeter, honeyed, fruity, and resinous.</p>
          </div>
        </div>
      </section>

      <section id="summary" class="scroll-mt-28">
        <h2 class="text-2xl font-display text-black mb-4">6. Sourcing Pure Royal Oud in Dubai</h2>
        <p class="text-base leading-relaxed text-[rgba(0,0,0,0.8)] mb-6">
